...
template <typename Archive> void serialize (Archive&, eclipse::SmallBlockMetadata&, unsigned);
...
BOOST_CLASS_EXPORT_KEY(eclipse::SmallBlockMetadata);
...
BOOST_CLASS_TRACKING(eclipse::SmallBlockMetadata, boost::serialization::track_never);
